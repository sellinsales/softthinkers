-- LingoHunt API phpMyAdmin import script
-- Safe to import into phpMyAdmin.
-- If the database already exists, this will reuse it.

CREATE DATABASE IF NOT EXISTS `softthinkers_lingohunt`
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;

USE `softthinkers_lingohunt`;
